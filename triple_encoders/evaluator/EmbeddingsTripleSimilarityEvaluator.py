...
class EmbeddingsTripleSimilarityEvaluator(SentenceEvaluator):
    """
    ...
    def __init__(self, sentences1: List[str],
                 ...
                 scores: List[float], batch_size: int = 16, main_similarity: SimilarityFunction = None, name: str = '', show_progress_bar: bool = False, write_csv: bool = True):
        """
    ...
    def from_input_examples(cls, examples: List[InputExample], **kwargs):
        ...
        return cls(sentences1, sentences2, sentences3, scores, **kwargs)
    ...
    def __call__(self, model, output_path: str = None, epoch: int = -1, steps: int = -1) -> float:
        ...
        embeddings3 = model.encode(self.sentences3, batch_size=self.batch_size, show_progress_bar=self.show_progress_bar, convert_to_numpy=True)

        # mean embeddings1 and embeddings2 pairwise
        embeddings1 = np.mean(np.stack([embeddings1, embeddings2]), axis=0)
